            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="search.jsp"><i class="fa fa-dashboard fa-fw"></i> Search</a>
                        </li>
                        <li>
                            <a href="employeeUpdate.jsp"><i class="fa fa-edit fa-fw"></i> Employee Update</a>
                        </li>
                        <li>
                            <a href="requestStatus.jsp"><i class="fa fa-search fa-fw"></i> Request Status</a>
                        </li>
                        <li>
                            <a href="RequestForm.jsp"><i class="fa fa-edit fa-fw"></i> New Request Form</a>
                        </li>
                        <li>
                            <a href="employeeTracking.jsp"><i class="fa fa-edit fa-fw"></i> Employee Tracking</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
